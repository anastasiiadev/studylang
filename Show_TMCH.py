...
class ThisWindow(QWidget):
    ...
    def __init__(self, n, i, question, filename, d, maxscore):
        super().__init__()
        self.num = n
        self.n = i
...
if __name__=="__main__":
    ...
    myapp = ThisWindow(3, 1, 'Fill in the gaps.', 'answerfiles/Test2.txt', {'My father works as a ... from home': 'freelancer', 'Do you often work ...?': 'overtime', 'My brother has to meet tough ...': 'deadlines', 'A ... is a person people pay money to in a shop': 'cashier'}, '4')
    myapp.show()
    sys.exit(app.exec_())