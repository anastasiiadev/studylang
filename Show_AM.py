...
class ThisWindow(QWidget):
    ...
    def __init__(self, n, i, question, audiofile, answers, filename, rightanswers, maxscore):
        super().__init__()
        self.num = n
        self.n = i
...
if __name__ == '__main__':
    ...
    window = ThisWindow(3, 3, 'Listen to the recording. Tick true statements.', 'nature_disaster.mp3', ['The speaker is a journalist.', 'The speaker is a member of a rescue team.', 'There has been an earthquake.', 'There has been an avalanche.'], 'answerfiles/Test1.txt', ['The speaker is a member of a rescue team.', 'There has been an earthquake.'], '3')
    sys.exit(app.exec_())
